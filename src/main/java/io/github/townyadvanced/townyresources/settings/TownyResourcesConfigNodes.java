...
//	TOWN_RESOURCES_OFFERS_MMOITEMS_ROOT("town_resources.offers.mmoitems", "", "", ""),
//	TOWN_RESOURCES_OFFERS_MMOITEMS_PLAYER_LEVELED_ITEMS("town_resources.offers.mmoitems.player_leveled_items",
//			"false",
//			"",
//			"# When players collect MMOItems are MMOItems leveled using the player running the collect command,",
//			"# or are they given as base-items?",
//			"# Setting this to true will result in powerful players getting more powerful items."),
