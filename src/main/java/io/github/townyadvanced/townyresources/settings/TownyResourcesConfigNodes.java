...
public enum TownyResourcesConfigNodes {
	...
	TOWN_RESOURCES_SURVEY_PLOTS_ROOT("surveysite_plots", "", "", "",
			...
			"# | SurveySite plot type. Doing so will result in an Un- | #",
			"# | used SurveySite. /plot perm will show the Biome that | #",
			"# | the plot type has as a majority. When stood in the   | #",
			"# | plot a player can use /t resources survey, to have   | #",
			"# | the plot discover a resource and become Used.        | #",
