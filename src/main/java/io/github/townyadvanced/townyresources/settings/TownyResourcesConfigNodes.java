...
public enum TownyResourcesConfigNodes {
	...
	TOWN_RESOURCES_OFFERS_CATEGORIES(
		   ...
		   "",
			...
			"# ",
			"# Each category is enclosed in curly brackets, and has 4-5 parts:",
			"# 1 - The name of the category (used for messaging)",
			"# 2 - The discovery weight of the category (used during discovery)",
			"# 3 - The base amount of the offer (in stacks)",
			"# 4 - (Optional) The required resource level of the town. When this is left out,",
			"#     it will not apply to the category. When it is set to 2, the category will",
			"#     only become available when a town is discovering their 2nd or higher resource.",
			"#     This is useful to make certain categories only appear when town's are discovering",
			"#     their later resources.",
			"# 5 - The list of materials in the category",
			"# ",
	...
	TOWN_RESOURCES_SURVEY_PLOTS_ROOT("surveysite_plots", "", "", "",
			...
			"# |                   SurveySite Plots                   | #",
			"# |                                                      | #",
			"# | Surveysite plots are used to make resource-discovery | #",
			"# | biome-dependent. When surveysite plots are enabled   | #",
			"# | towns will be able to set their townblocks to the    | #",
			"# | SurveySite plot type. SurveySite plots are set using | #",
			"# | the /plot set surveysite command.                    | #",
			"# | Doing so will result in an Un-used SurveySite.       | #",
			"# | The /plot info command will show the Biome that the  | #",
			"# | plot type has as a majority. When stood in the plot  | #",
			"# | a player can use /t resources survey, to have the    | #",
			"# | plot discover a resource and become Used.            | #",
			"# | SurveySite plots cannot be unclaimed or have their   | #",
			"# | plot type changed from SurveySite, except by admins. | #",
			"# |                                                      | #",
			"# | If you have SurveySite plots disabled, towns will    | #",
			"# | discover resources independent of biome.             | #",
			"# +------------------------------------------------------+ #",
			"############################################################",
			""),
